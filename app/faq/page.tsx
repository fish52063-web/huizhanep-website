...
const faqSections = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: '裝潢後細清費用大約多少？', answer: '裝潢後細清費用依照面積大小、裝潢程度而定。實際費用需到場評估後提供準確報價，歡迎來電預約免費到府估價。' },
      { question: '除甲醛費用怎麼算？', answer: '除甲醛費用依照面積大小、甲醛濃度、使用的除甲醛技術而定。建議先做甲醛檢測再評估施工方案，歡迎來電預約免費檢測。' },
